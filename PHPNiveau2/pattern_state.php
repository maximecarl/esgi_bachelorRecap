...
class EnAttente implements EtatInterface
{
    private ContexteInterface $contexte;
...
class Annule implements EtatInterface
{
    private $contexte;
...
class Valide implements EtatInterface
{
    private $contexte;
...
class Expedie implements EtatInterface
{
    private $contexte;
...
class Rembourse implements EtatInterface
{
    private $contexte;
...
class Livre implements EtatInterface
{
    private $contexte;
...
En attente de validation de paiement --> paiement validé --> expédié --> Livré --> remboursé
...
*/
/*
// Scénario 2 (= Scénario nominal + ce qui suit ET vérifier l'exception signalant une transition impossible de EnAttente vers Rembourse)
...
// Scénario 4
// Le paiement n'a pas été effectué dans les délais, il est frauduleux ou une erreur
